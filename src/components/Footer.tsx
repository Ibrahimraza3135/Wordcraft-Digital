      ...
      <Helmet>
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "logo": "https://wordcraft-digital.com/logo.png", // replace with actual logo
            "sameAs": [
              "https://www.facebook.com/Wordcraft-Digital",
              "https://twitter.com/Wordcraft-Digital",
              "https://www.linkedin.com/company/Wordcraft-Digital"
            ],
            "contactPoint": {
              "@type": "ContactPoint",
              "email": "steve@wordcraft-digital.com",
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="border-t border-zinc-900 mt-10 pt-6 text-center text-sm">
            <p className="text-gray-500">
              &copy; {currentYear} Wordcraft-Digital. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
