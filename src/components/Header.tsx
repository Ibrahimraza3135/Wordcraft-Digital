...
export default function Header({ currentPage, onNavigate }: HeaderProps) {
  ...
  return (
    <>
      {/* SEO Meta Tags */}
      <Helmet>
        <title>{pageMeta[currentPage]?.title || 'Wordcraft-Digital'}</title>
        <meta name="description" content={pageMeta[currentPage]?.description || ''} />
        <link rel="canonical" href={`https://wordcraft-digital.com/${currentPage}`} />
        ...
        <meta property="og:url" content={`https://wordcraft-digital.com/${currentPage}`} />
      </Helmet>
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center">
            ...
            >
              Wordcraft<span className="text-amber-600">Digital</span>
            </button>
