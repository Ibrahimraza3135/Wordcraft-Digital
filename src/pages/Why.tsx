...
export default function Why({ onNavigate }: WhyProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-[#FAF9F6] to-amber-50/20 pt-24 pb-12">
      {/* ================= SEO ================= */}
      <Helmet>
        <title>Why Choose Wordcraft Digital | Wikipedia Experts</title>
        <meta
          name="description"
          content="Learn why Wordcraft Digital is the leading Wikipedia service provider. We ensure your page is compliant, accurate, and maximizes survival chances."
        />
        <link rel="canonical" href="https://wordcraft-digital.com/why" />

        {/* Open Graph */}
        <meta property="og:title" content="Why Choose Wordcraft Digital | Wikipedia Experts" />
        <meta
        ...
        />
        <meta property="og:url" content="https://wordcraft-digital.com/why" />
