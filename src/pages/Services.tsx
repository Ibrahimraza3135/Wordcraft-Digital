...
export default function Services({ onNavigate }: ServicesProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-[#FAF9F6] to-amber-50/20 pt-24 pb-12">
      {/* ================= SEO ================= */}
      <Helmet>
        <title>Services | Wordcraft Digital Wikipedia Services</title>
        <meta
          name="description"
          content="Explore Wordcraft Digital's professional Wikipedia services: Notability Assessment, Page Creation, Page Rewrite, and Monitoring & Maintenance."
        />
        <link rel="canonical" href="https://wordcraft-digital.com/services" />

        {/* Open Graph */}
        <meta property="og:title" content="Services | Wordcraft Digital" />
        <meta
        ...
        <AnimatedSection>
          <div className="text-center mb-16">
            ...
            <p className="text-xl md:text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Wordcraft-Digital is a full-service Wikipedia content agency. We
