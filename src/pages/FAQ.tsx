...
export default function FAQ({ onNavigate }: FAQProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-[#FAF9F6] to-amber-50/20 pt-24 pb-12">
      {/* ================= SEO ================= */}
      <Helmet>
        <title>FAQ | Wordcraft Digital Wikipedia Services</title>
        <meta
          name="description"
          content="Frequently Asked Questions about Wikipedia page creation, editing, and notability assessment by Wordcraft Digital."
        />
        <link rel="canonical" href="https://wordcraft-digital.com/faq" />

        {/* Open Graph */}
        <meta property="og:title" content="FAQ | Wordcraft Digital" />
        <meta
          property="og:description"
          content="All your questions answered about creating, editing, and maintaining a Wikipedia page."
        />
        <meta property="og:url" content="https://wordcraft-digital.com/faq" />
