...
export default function About({ onNavigate }: AboutProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-[#FAF9F6] to-amber-50/20 pt-24 pb-12">
      {/* ================= SEO ================= */}
      <Helmet>
        <title>About Wordcraft Digital | Wikipedia Page Creation Experts</title>
        <meta
          name="description"
          content="Learn about Wordcraft Digital's mission, team, and values. We are professional Wikipedia writers and editors helping brands build digital credibility."
        />
        <link rel="canonical" href="https://wordcraft-digital.com/about" />

        {/* Open Graph */}
        <meta property="og:title" content="About Wordcraft Digital | Wikipedia Page Creation Experts" />
        <meta
          property="og:description"
          content="Get to know the team behind Wordcraft Digital and our commitment to Wikipedia policy compliance."
        />
        <meta property="og:url" content="https://wordcraft-digital.com/about" />
            ...
            <div className="bg-white border border-amber-500/10 rounded-3xl p-8 md:p-12 shadow-xl gold-shadow">
              <div className="space-y-6 text-lg md:text-xl text-gray-700 leading-relaxed">
                <p className="animate-slide-in-1">
                  <strong className="text-gray-900">Wordcraft-Digital</strong> is a
