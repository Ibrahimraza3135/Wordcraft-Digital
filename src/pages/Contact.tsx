...
export default function Contact() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-[#FAF9F6] to-amber-50/20 pt-24 pb-12">
      {/* ================= SEO ================= */}
      <Helmet>
        <title>Contact Wordcraft Digital | Wikipedia Page Consultation</title>
        <meta
          name="description"
          content="Get in touch with Wordcraft Digital for professional Wikipedia page creation, editing, and notability assessment services."
        />
        <link rel="canonical" href="https://wordcraft-digital.com/contact" />

        {/* Open Graph */}
        <meta property="og:title" content="Contact Wordcraft Digital" />
        <meta
          property="og:description"
          content="Reach out for expert Wikipedia consulting, article creation, and page monitoring services."
        />
        <meta property="og:url" content="https://wordcraft-digital.com/contact" />
        ...
        <script type="application/ld+json">
          {`
          {
            ...
            "@type": "ContactPage",
            "name": "Contact Wordcraft Digital",
